...
const peripherals = [
  { name: 'Keyboard', description: 'Mechanical, RGB, Tenkeyless' },
  { name: 'Mouse', description: 'Wireless, Lightweight, 16000 DPI' },
  { name: 'Monitor', description: '27-inch, 144Hz, IPS Panel' },
  { name: 'PC Case', description: 'Mid-Tower, Tempered Glass, High Airflow' },
];

export function PeripheralsDrawer() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      >
        <Image
          src="https://i.imgur.com/Xbiudsl.png"
          alt="My Peripherals"
          width={1600}
          height={600}
        ...
        <div className="p-4 text-white text-center">
            ...
            <p className="text-sm opacity-90">Complete workstation essentials</p>
      ...
      >
         <div className="p-4 bg-black border border-[#040707] rounded-lg shadow-2xl shadow-slate-900/50">
            ...
            {peripherals.map((item, index) => (
                <div key={index} className="bg-[#040707] p-3 rounded-md border border-gray-800/50 text-left">
